...
public enum BombType implements WeightedSpace
{
	...
	THRESHOLDUD ( 1, "BOMB") { public Bomb getBomb() { return new ThresholdDudBomb(); } }, //See above
	CURSED		( 0, "CURSED BOMB") { public Bomb getBomb() { return new CursedBomb(); } }, //Generated by Bowser
