...
public enum Prize {
	...
	S12TROPHY(   25200,"a replica of DatFatCat137's Season 13 :banana: trophy"),
	...
	TRISCUIT	(       5,"THE TRI... scuit"), //Wow, not here? Try again!
	EVERYTHING	(      15,"EVERYTHING... the video game"), //on Steam it's $15
	DUCKS		(      22,"two little ducks"), //Bingo lingo
	BULLSEYE	(      50,"a bullseye"), //Bullseye on a dartboard is worth 50
	FARFETCHD	(      83,"a leeky duck"), //Farfetch'd from Pokemon
	VOTE		(     100,"a vote"), //Blaseball
	...
	KEROKERO	(     200,"Kerokero Cola"), //Super Mario RPG
	QUIPLASH	(     250,"a Quiplash"), //Quiplash, Jackbox
	...
	MMBAR		(     811,"a Mega Man bar"), //Arcade Pit
	PEANUTS		(    1000,"a bucket of peanuts"), //Blaseball
	SMILECLOCK	(    1010,"a smiling clock"), //Clocks are set to 10:10 to make it seem like they're smiling
	...
	SWIFTIE		(    1989,"a Taylor Swift album"), //
	...
	IMPOSSIBLE	(   20000,"an Impossible Question"), //You Don't Know Jack
	PLINKO		(   20000,"a Plinko Chip"), //Max value per chip on The Price is Right's Plinko
	...
	CATCHPHRASE	(   50000,"a catchphrase"), //The game show Catchphrase
	PLUSH		(   54000,"a Rosy Maple Moth plushie"), //Cute
	NORMALCD	(   54321,"a Normal Countdown"), //Not a Final Countdown
	THAILAUGH	(   55555,"Thai canned laughter"), //55555 is a way to express laughter in Thai
	...
	THEREMIN	(   73000,"a magical theremin"), //They are pretty cool musical instruments
	DUCKDO		(   75000,"a duck haircut"), //Dokapon Kingdom
