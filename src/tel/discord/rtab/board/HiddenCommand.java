...
public enum HiddenCommand implements WeightedSpace
{
	...
	REPEL(11, """
			**BLAMMO REPELLENT**!
			...
			You may alternatively use this when there is no blammo in play to cure a threshold situation.""",
			"You currently possess **BLAMMO REPELLENT**.\n"
			+ "You may use it when a blammo is in play or to remove a threshold situation by typing **!repel**.");
